  ...
  return (
    <footer className=" bg-white min-h-screen">
       {/* rounded-t-[50px] md:rounded-tl-[180px] lg:rounded-tl-[150px] */}
        ...
        <div className="min-h-screen px-6 sm:px-30 pt-40 pb-10 bg-black text-white mt-20   rounded-tl-[55%] rounded-tr-[55%] md:rounded-tl-[40%] md:rounded-tr-[40%] lg:rounded-tl-[30%] lg:rounded-tr-[30%]">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <div className="flex flex-wrap gap-4">
            {LEGAL_LINKS.map((label) => (
              <ul className="flex items-center gap-5" key={label.label}>
